...
export default function OSDistribution({ token, days }: Props) {
  ...
  useEffect(() => {
    ...
    fetch(
      `http://localhost:8000/dashboards/metrics/os-distribution?token=${token}&days=${days}`
    )
      .then((r) => {
  ...
  return (
    <div className="chart-card">
      <div className="chart-header">Операционные системы</div>
